    ...
    <body class="login-layout light-login">
        <div id="navbar" class="navbar navbar-default">
            <a href="#" class="navbar-brand">
                <small>
                    <marquee>Selamat Datang di Sistem Informasi Pengolahan Data Alumni STKIP 'AISYIYAH RIAU</marquee>
                </small>
            </a>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    <span class="black" id="id-text2">Sistem Data Alumni</span>
                                </h1>
                                <h4 class="blue" id="id-company-text">STKIP 'AISIYIYAH RIAU</h4>
                            </div>
